    ...
    return (
        <div>
            ...
            <h3>
                ...
                <p>Pri osobnom odbere tovaru v našej prevádzke alebo v našom sklade je možná platba v hotovosti, alebo online cez platobnú bránu TrustPay na našom eshope vinecka.sk. </p>
                <p>Pri doručení prostredníctvom kuriéra je možné zaplatiť za tovar a doručenie v hotovosti </p>
            <h3>
                <strong>Predávajúci sa zaväzuje </strong> 
            </h3>
                <p>Dodať správny druh a množstvo tovaru, tak ako bolo uvedené v čase objednávky, na základe objednávky zákazníka v dohodnutej cene, adekvátne zabaliť tovar a odoslať tovar v dohodnutej lehote. </p>
            <h3>
                <strong>Kupujúci sa zaväzuje </strong> 
            </h3>
                <p>Prevziať zakúpený, resp. objednaný tovar na dobierku a zaplatiť sumu uvedenú v objednávke. </p>
            <h3>
            ...
            <p>Záruka na dodaný tovar je 2 roky od zakúpenia tovaru, resp. do uplynutia doby trvanlivosti. Doba trvanlivosti je pri tovare potravinárskeho charakteru uvedená priamo na jeho obale. Záruku poskytujeme iba v prípade dodržania skladovacích podmienok uvedených na obale tovaru. Dodávateľ môže odmietnuť reklamáciu, ak reklamovaná chyba tovaru môže byť spôsobená nesprávnym skladovaním u zákazníka. </p>
            <h3>
                <strong>Vrátenie tovaru </strong> </h3>
                <p>Tovar je možné vrátiť alebo zameniť za nasledovných podmienok : </p>
            <ul style={{textAlign: 'left', paddingLeft: '10%'}}>
                <li>Kolok na tovare je neporušený </li>
                <li>Tovar je v pôvodnom stave &#8211; nepoškodený, vrátane originálnych obalov &#8211; nepoškodených </li>
                <li>Tovar nesmie byť po expirácií </li> 
            </ul>
            <p>Podľa platnej legislatívy EÚ máte právo od objednávky odstúpiť a tovar vrátiť do 7 pracovných dní odo dňa jeho prevzatia. Nepoužitý, nepoškodený tovar v pôvodnom obale spolu s dodacím listom a označením, že ide o vrátenie tovaru je potrebné zaslať na adresu nášho skladu (Križanovič &amp; Prievozník s. r. o., so sídlom Hradská 66/51 900 82 Blatné, 902 01 Pezinok). Doručenie vráteného tovaru je na Vaše náklady. Výnimku tvoria potravinárske výrobky, ktoré nie je možné po zakúpení vrátiť. </p>
            <h3>
            <strong>Ceny </strong> </h3>
            <p>Ceny v e-shope sú uvedené s DPH. </p>
            <h3>
            <strong>Záverečné ustanovenia </strong> </h3>
            <p>Podľa zákona č. 128/2002 Z. z. o štátnej kontrole je všeobecným orgánom trhového dozoru vo veciach ochrany spotrebiteľa na vnútornom trhu Slovenská obchodná inšpekcia (SOI), Inšpektorát SOI pre Bratislavský kraj, Prievozská 32, P. O. Box 5, 820 07  Bratislava 27, odbor technickej kontroly výrobkov a ochrany spotrebiteľa.
            <br />Tieto všeobecné obchodné podmienky a právny poriadok Slovenskej republiky sa vzťahujú na všetky kúpne zmluvy, uzavreté prostredníctvom internetovej stránky nášho internetového obchodu a sú neoddeliteľnou súčasťou kúpnej zmluvy medzi nami. Vyhradzujeme si právo na zmenu týchto všeobecných obchodných podmienok. Povinnosť písomného oznámenia zmeny v týchto všeobecných obchodných podmienkach je splnená umiestnením na internetovej stránke nášho internetového obchodu.
            <br />Zaslaním objednávky potvrdzujete, že ste si tieto všeobecné obchodné podmienky prečítali a v celom rozsahu s nimi súhlasíte. </p>
            <p>Zaslaním objednávky alkoholu potvrdzujete, že ste dovŕšili vek 18 rokov. </p> 
        </div>
    )
}